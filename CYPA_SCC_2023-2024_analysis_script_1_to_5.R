...
# 
# write.csv(flat.all,
#           "G:/Alex Harley/Audit_2023_onwards/2023-2024/CYPA/Analysis/Output/DB_selected_elements_1_to_5.csv",
#           row.names = FALSE)
...
write.csv(clean,
          "G:/Alex Harley/Audit_2023_onwards/2023-2024/CYPA/Analysis/Output/CYPA_SCC_2023-2024_national_country_hospital_level_data_1_to_5.csv",
          row.names = FALSE)
